...
describe "MarkdownLists", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('markdown-lists')

  describe "when the markdown-lists:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'markdown-lists:toggle'
        expect(markdownListsPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'markdown-lists:toggle'
        expect(markdownListsElement).not.toBeVisible()
